    ...
    <>
      ...
      <div className="page-content">
        ...
        <p style={{ color: '#666', marginBottom: '1rem' }}>
          ...
          Patrick&apos;s real experience. Generated server-side via OpenAI &mdash; no API keys exposed to the browser.
        </p>
        ...
        <form className="cover-form" onSubmit={handleGenerate}>
          ...
          <label style={{ fontWeight: 600, fontSize: '0.9rem' }}>
            Job Description (optional &mdash; paste full posting for best results)
          </label>
          <textarea
          ...
          <label style={{ fontWeight: 600, fontSize: '0.9rem' }}>
            Additional Notes (optional &mdash; anything Patrick wants to mention)
          </label>
          <textarea
